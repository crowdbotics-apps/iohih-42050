"""
Django settings for iohih_42050 project.
...
WSGI_APPLICATION = 'iohih_42050.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "iohih_42050 API",
    "DESCRIPTION": "API documentation for iohih_42050 App",
    "VERSION": "v1",
}
